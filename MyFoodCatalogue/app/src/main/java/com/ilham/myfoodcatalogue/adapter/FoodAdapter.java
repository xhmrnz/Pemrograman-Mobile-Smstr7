...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.viewHolder> {
    ...
    public FoodAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        final FoodAdapter.viewHolder viewHolder = new FoodAdapter.viewHolder(view);
        viewHolder.cardView.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailActivity.class);
                intent.putExtra("EXTRA_FOOD", foods.get(viewHolder.getAdapterPosition()));
    ...
    public void onBindViewHolder(@NonNull FoodAdapter.viewHolder holder, int i) {
        holder.title.setText(foods.get(i).getName());
        holder.desc.setText("Rp." + foods.get(i).getHarga());

        Glide.with(context)
                .load(foods.get(i).getPhoto())
